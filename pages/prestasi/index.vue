...
import PrestasiSections from '~/components/Prestasi/PrestasiSections.vue';
...
const categoryUrl = '/prestasi-category/all';
const articleUrl = '/prestasi';
...
useHead({
  title: `Prestasi | ${brand.education.descSecondary}`,
});
</script>
